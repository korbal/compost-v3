  ...
  <div>
    <div class="content">
      <div class="max-w-md mx-auto px-5">
        ...
        >
          <div
            class="relative flex items-center w-full h-12 rounded-lg focus-within:shadow-lg bg-white overflow-hidden shadow px-10"
          >
        ...
        <div
          ...
          class="item-bg error relative flex items-center h-12 rounded-lg focus-within:shadow-lg bg-white overflow-hidden shadow item-class item-bg w-full text-gray-700 leading-tight focus:outline-none focus:shadow-outline drop-shadow-lg mb-1 mt-1"
        >
          <div
            class="relative flex items-center w-full h-12 rounded-lg focus-within:shadow-lg bg-red-300 overflow-hidden shadow px-10"
          >
